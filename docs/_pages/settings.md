...
<ol>
    ...
    <li><strong>Exported APK Name</strong> – Choose how exported APK files are named. Options include:
        <ul>
            <li><strong>Package Name</strong> (Default)</li>
            <li><strong>App Name</strong></li>
            <li><strong>App Name + Package ID + Version</strong></li>
            <li><strong>Custom Template</strong> – Create your own naming format (e.g., <code>{appname}-{packageid}-{versionname}</code>).</li>
        </ul>
    </li>
