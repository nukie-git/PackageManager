...
public class sAPKUtils {
    ...
    public static long getVersionCode(String apkPath, Context context) {
        PackageInfo pi = getPackageInfo(apkPath, context);
        return pi != null ? androidx.core.content.pm.PackageInfoCompat.getLongVersionCode(pi) : 0L;
    }
